...
CONSTRAINT ORDERS_Employees_EmployeeID_fk FOREIGN KEY(EMPLOYEEID) REFERENCES Employees(EmployeeID),
CONSTRAINT ORDERS_CUSTOMERS_CUSTOMERID_fk FOREIGN KEY(CUSTOMERID) REFERENCES CUSTOMERS(CUSTOMERID),
...
CONSTRAINT Products_Suppliers_SupplierID_fk FOREIGN KEY(SupplierID) REFERENCES Suppliers(SupplierID),
CONSTRAINT Products_Categories_CategoryID_fk FOREIGN KEY(CategoryID) REFERENCES Categories(CategoryID)
);
...
CONSTRAINT ORDERDETAILS_Products_ProductID_fk FOREIGN KEY(PRODUCTID) REFERENCES Products(ProductID),
